    ...
    withScene((scene) => {
        ...
        Object.keys(towersDict).forEach(typeKey => {
            ...
            towers.forEach(tower => {
                ...
                if (tower.stats) {
                    tower.stats.dmg = 1e+10;      // Massive Damage
                    tower.stats.range = 1e+10;       // Map-wide Range
                    tower.stats.fireRate = 1e+10;      // Ultra Fast
                    tower.stats.ghostDetect = true; // Hit Ghosts
                    tower.stats.maxTargets = 1e+10;  // Hit everything at once
